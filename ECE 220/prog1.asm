...
PRINT_HIST
	...
	LD R3, HIST_ADDR	;Loads start of addr in R3 
	ST R3, SAVE_R3		;STORES VALUE IN R3
...
PRINT_HEX
	...
	LDI R3, SAVE_R3		;Loads count into R3
...
SAVE_R3		.BLKW #1	; Mem save for R3
